...
#ifndef _GLOW_BUNDLE_NEW_OP_TYPE_STR_H
#define _GLOW_BUNDLE_NEW_OP_TYPE_STR_H
...
#define NEW_OP_TYPE_STR_inputs         0
#define NEW_OP_TYPE_STR_relu_0_output  1024

// Memory sizes (bytes).
#define NEW_OP_TYPE_STR_CONSTANT_MEM_SIZE     0
#define NEW_OP_TYPE_STR_MUTABLE_MEM_SIZE      2048
#define NEW_OP_TYPE_STR_ACTIVATIONS_MEM_SIZE  0

// Memory alignment (bytes).
#define NEW_OP_TYPE_STR_MEM_ALIGN  64

// Bundle entry point (inference function). Returns 0
// for correct execution or some error code otherwise.
int new_op_type_str(uint8_t *constantWeight, uint8_t *mutableWeight, uint8_t *activations);
